...
class DownloadService : Service() {
    ...
    private fun downloadFile(body: ResponseBody, filename: String, id: Int) {
        ...
        val outputFile = File(
            Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).absolutePath.toString() +
    ...
    private fun onDownloadComplete(filename: String, id: Int) {
        try {
            ...
            val path1 = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).absolutePath.toString() +
                    File.separator + "/" + filename
